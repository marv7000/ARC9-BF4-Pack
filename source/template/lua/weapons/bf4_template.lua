...
SWEP.Spawnable = true
SWEP.Category = "ARC-9 Battlefield 4"
...
SWEP.Credits = {
    Author = "Ma_rv",
    Contact = "https://steamcommunity.com/id/ma_rv/",
}

SWEP.Description = [[A Battlefield 4 gun. (If you see this then I fucked up)]]
...
SWEP.ViewModel = "models/weapons/bf4/"
SWEP.WorldModel = "models/weapons/bf4/"
